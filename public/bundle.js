...
const galeria$4 = document.querySelector("#galeria");
...
const cargarImagen = (id,nombre,ruta,descripcion) => {
    ...
    if (galeria$4.querySelectorAll(".galeria__carousel-slide").length > 0) {
        ...
        // Marcamos la imagen activa con el borde en blanco
...
const galeria$3 = document.querySelector("#galeria");
...
contenedorCategorias.addEventListener("click", (e) => {
    ...
    fotos.forEach((foto) => {
        ...
        galeria$3.querySelector(".galeria__carousel-slides").innerHTML += `
...
const galeria$2 = document.querySelector(".galeria");
...
const galeria$1 = document.querySelector("#galeria");
